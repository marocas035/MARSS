    ...
    class LABehav(OneShotBehaviour):
        async def run(self):
            ...
            if order_code != "No":
                ...
                rq_contact_list = opf.rq_list_br(my_full_name, r).to_json(orient="records")   #función que solicita a browser contact list
                ...
                if msg_cl:
                    ...
                    opf.change_warehouse(la_inform_log_json, my_dir) #,contact_list)
